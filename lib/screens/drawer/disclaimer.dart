...
class Disclaimer extends StatelessWidget {
  final String text1 =
      "This App calculates POG by subtracting LMP from Today's date. The result so obtained in month and days is converted into days and then into weeks. Other method commonly used by obstetricians: counting 4 weeks for every month and 13 weeks for every 3 months may give different result and is less accurate. Considerations need to be taken";
  final String text2 =
